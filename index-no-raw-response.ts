...
async function main() {
  const profileUrl = "https://www.linkedin.com/in/mateofioritorocha/";
  ...
  // Prompt for GPT‑4
  const prompt = `
You are an AI assistant specialized in analyzing social media profiles for personalized sales outreach. The following JSON object contains data scraped from a LinkedIn profile, including the lead's main profile details and up to the latest 5 posts.
